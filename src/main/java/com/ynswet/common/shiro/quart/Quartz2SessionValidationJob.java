package com.ynswet.common.shiro.quart;
 ...
 * @since 0.1
 */
public class Quartz2SessionValidationJob implements Job {
    ...
    ============================================*/
    private static final Logger log = LoggerFactory.getLogger(Quartz2SessionValidationJob.class);
