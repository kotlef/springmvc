 ...
 * under the License.
 */
package com.ynswet.system.sc.crypto;
 ...
 * to be {@link com.ynswet.system.sc.util.ByteSource#toHex() hex} or
 * {@link com.ynswet.system.sc.util.ByteSource#toBase64() base64}-encoded.</li>
 * </ul>
 * For example, consider the following example generating password salts for new user accounts:
 * <pre>
 * RandomNumberGenerator saltGenerator = new {@link com.ynswet.system.sc.crypto.SecureRandomNumberGenerator SecureRandomNumberGenerator}();
 * User user = new User();
