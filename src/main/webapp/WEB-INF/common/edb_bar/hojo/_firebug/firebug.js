...
if(!hojo._hasResource["hojo._firebug.firebug"]){
hojo._hasResource["hojo._firebug.firebug"]=true;
hojo.provide("hojo._firebug.firebug");
hojo.deprecated=function(_1,_2,_3){
...
hojo.experimental=function(_5,_6){
...
if(!hojo.isFF&&!hojo.isChrome&&!hojo.isSafari&&!_8&&!window.firebug&&(typeof console!="undefined"&&!console.firebug)&&!hojo.config.useCustomLogger&&!hojo.isAIR){
try{
...
hojo.destroy(_f.firstChild);
}
}
hojo.forEach(this._connects,hojo.disconnect);
},open:function(){
_34(true);
},close:function(){
if(_14){
...
_1a=hojo.connect(document,"mousemove",function(evt){
if(!_1c){
return;
}
if(!_1d){
...
setTimeout(function(){
_1b=hojo.connect(document,"click",function(evt){
...
if(hojo.config.debugContainerId){
_e=_b.getElementById(hojo.config.debugContainerId);
}
if(!_e){
...
btn.obj=obs[i];
_c.console._connects.push(hojo.connect(btn,"onclick",function(){
...
_b6=(_b6)?hojo.fromJson(_b6):[];
var pos=hojo.indexOf(_b6,_b5);
if(pos!=-1){
_b6.splice(pos,1);
}
_b6.push(_b5);
_b7("firebug_history",hojo.toJson(_b6),30);
...
_49(document,hojo.isIE||hojo.isSafari?"keydown":"keypress",_4b);
if((document.documentElement.getAttribute("debug")=="true")||(hojo.config.isDebug)){
_34(true);
}
hojo.addOnWindowUnload(function(){
_a1(document,hojo.isIE||hojo.isSafari?"keydown":"keypress",_4b);
