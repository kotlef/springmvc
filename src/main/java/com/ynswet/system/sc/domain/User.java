 ...
 */
@Entity
@Table(name = "user", catalog = "d1", uniqueConstraints = {
...
public class User implements java.io.Serializable {
	...
	@Column(name = "ID_NO", unique = true,  length = 30)
	...
	@Column(name = "CELL", unique = true,  length = 30)
