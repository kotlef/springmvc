 ...
 * under the License.
 */
package com.ynswet.system.sc.crypto.hash;

import com.ynswet.system.sc.crypto.RandomNumberGenerator;
import com.ynswet.system.sc.crypto.SecureRandomNumberGenerator;
 ...
 * {@link #setRandomNumberGenerator(com.ynswet.system.sc.crypto.RandomNumberGenerator) randomNumberGenerator} property.
...
public class DefaultHashService implements ConfigurableHashService {
     ...
     * <li>{@link #setRandomNumberGenerator(com.ynswet.system.sc.crypto.RandomNumberGenerator) randomNumberGenerator} =
     ...
     * <ul>
     * <li>If the request's {@link com.ynswet.system.sc.crypto.hash.HashRequest#getSalt() salt} is null:
     * <p/>
