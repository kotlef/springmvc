...
public class JacksonMapper {
	 ...
	 * <ul>
	 * <li>
	 * 如果是 {@link java.util.Collections} 或 {@link java.util.Map} 。根据
	 * <code>isEmpty()</code>方法返回值判断是否序列化</li>
	 * <li>
	 * 如果是Java数组，长度等于0都为空值的情况</li>
	 * <li>
	 * 如是String类型根据 <code>length()</code>方法返回值判断是否序列化,如果为0表示该值为空</li>
	 * </ul>
	 * </p>
	 * 其他类型的默认处理为：空值将一样加入。
	 * <p>
	 * 提示：其他类型的默认处理可以自定义{@link JsonSerializer}的
	 * {@link JsonSerializer#isEmpty(Object)}如果被重写， 序列化json会调用该方法，根据返回值判断是否序列化
	 * </p>
	 * 
