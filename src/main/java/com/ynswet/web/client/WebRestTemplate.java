...
public class WebRestTemplate extends InterceptingHttpAccessor implements RestOperations {

	private static boolean romePresent =
			ClassUtils.isPresent("com.rometools.rome.feed.WireFeed", WebRestTemplate.class.getClassLoader());

	private static final boolean jaxb2Present =
			ClassUtils.isPresent("javax.xml.bind.Binder", WebRestTemplate.class.getClassLoader());

	private static final boolean jackson2Present =
			ClassUtils.isPresent("com.fasterxml.jackson.databind.ObjectMapper", WebRestTemplate.class.getClassLoader()) &&
					ClassUtils.isPresent("com.fasterxml.jackson.core.JsonGenerator", WebRestTemplate.class.getClassLoader());

	private static final boolean jackson2XmlPresent =
			ClassUtils.isPresent("com.fasterxml.jackson.dataformat.xml.XmlMapper", WebRestTemplate.class.getClassLoader());

	private static final boolean gsonPresent =
			ClassUtils.isPresent("com.google.gson.Gson", WebRestTemplate.class.getClassLoader());
	...
	/**
	 * Create a new instance of the {@link WebRestTemplate} using default settings.
	...
	/**
	 * Create a new instance of the {@link WebRestTemplate} based on the given {@link ClientHttpRequestFactory}.
	...
	/**
	 * Create a new instance of the {@link WebRestTemplate} using the given list of
	 * {@link HttpMessageConverter} to use
	 * @param messageConverters the list of {@link HttpMessageConverter} to use
	 * @since 3.2.7
	 */
	public WebRestTemplate(List<HttpMessageConverter<?>> messageConverters) {
	 ...
	 * <p>By default, WebRestTemplate uses a {@link DefaultResponseErrorHandler}.
	 */
